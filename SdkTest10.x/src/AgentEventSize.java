...
public class AgentEventSize
{
	...
	{
		private final UplinkCfg SINGLETON = UplinkCfgParser.createEmptyConfig(UplinkType.LOOPBACK_UPLINK);
		...
		public boolean notifyAgent(IBaseEventSource intr)
		{
		...
		/** <!-- ================================================================================================== -->
		 * (non-Javadoc)
		 * @see com.actional.lg.interceptor.internal.Uplink#meetsAllRequirements()
		 *
		 * @lastrev fixXXXXX - New method
		 * <!-- ------------------------------------------------------------------------------------------------ --> */
